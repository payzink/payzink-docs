...
Use the following card numbers in the sandbox environment to simulate different payment outcomes. These cards only work
with the sandbox API (`merchant-dev.payzink.com`).
