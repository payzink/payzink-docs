...
During the lifecycle of a payment, a transaction can transition through multiple states based on customer actions,
authentication steps, authorization results, captures, refunds, or risk outcomes.

These states allow your system to determine whether a transaction is still in progress, successfully completed,
partially processed, refunded, cancelled, or failed.
